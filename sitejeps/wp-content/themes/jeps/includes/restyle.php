...
function dashboard_widget_function( $post, $callback_args ) {
    echo "Contate os responsaveis EJES
";
}
...
function alterar_footer (){
    echo '<span id="footer-thankyou">Desenvolvido por <a href="http://www.ejes.com.br/">Empresa Junior de Engenharia de Software</a></span>';
}
